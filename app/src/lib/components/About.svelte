...
<div class="lg:grid lg:grid-cols-2">
    ...
    <div class="text-2xl pt-10 lg:pt-0">
        ...
        <br>
        <p class="flex">When I am not trying to make your life easier, I am often either learning some new, bleeding edge technology, trying to get good at a new video game, contributing to open source projects, noodling on the guitar, or catching up on my backlog of engineering books.</p>
    </div>
</div>